...
## CLI 生成器
通过[GitHub - kefranabg/readme-md-generator: 📄 CLI that generates beautiful README.md files](https://github.com/kefranabg/readme-md-generator)在命令行输入 `npx`指令生成readme文件。
