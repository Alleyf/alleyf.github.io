...
```sh
docker run -d --name nacos -p 8848:8848 -p 9848:9848 -p 9849:8849 --privileged=true -e JVM_XMS=256m -e JVM_XMX=256m -e MODE=standalone -v /home/ecs-user/mdware/nacos/logs/:/home/nacos/logs/ -v /home/ecs-user/mdware/nacos/conf/:/home/nacos/conf/ --restart=always nacos/nacos-server #未鉴权
docker run -d --name nacos -p 8848:8848 -p 9848:9848 
-p 9849:8849 --privileged=true -e JVM_XMS=256m -e JVM_XMX=256m -e MODE=standalone -e NACOS_AUTH_ENABLE=true -v /home/ecs-user/mdware/nacos/logs/:/home/nacos/logs/ -v /home/ecs-user/mdware/nacos/conf/:/home/nacos/conf/ --restart=always nacos/nacos-server #开启鉴权
```
**参数解释**：
