...
```sh
docker run -id --name mysql-2 -p 3307:3307  -v /data/mysql2/conf/my.cnf:/etc/mysql/my.cnf -v /data/mysql2/data:/var/lib/mysql -v /data/mysql2/log:/var/log/mysql -e MYSQL_ROOT_PASSWORD=123456 -e MYSQL_TCP_PORT=3307 --privileged=true mysql:5.7
```
此docker run命令的功能是:
