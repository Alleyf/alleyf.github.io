...
headingDivider:
  - 2
  - 3
footer: \ *范财胜（武汉理工大学）* *Paper Report* *2023年10月16日*
---
...
# 2 Awesome Marp：一套自定义 Marp 主题

###### 2.1.1.1.1.1 “用法简单且功能全面的个性化 PPT 模板”
...
# 3 Awesome Marp：一套自定义 Marp 主题

###### 3.1.1.1.1.1 “用法简单且功能全面的个性化 PPT 模板”
...
# 4 Awesome Marp：一套自定义 Marp 主题

###### 4.1.1.1.1.1 “用法简单且功能全面的个性化 PPT 模板”
...
# 5 <!-- fit -->Awesome Marp：一套自定义 Marp 主题

###### 5.1.1.1.1.1 “用法简单且功能全面的个性化 PPT 模板”
...
## 5.18 引用、链接和 Callouts

<!-- _class: trans -->
<!-- _footer: "" -->
<!-- _paginate: "" -->

## 5.19 引用、链接和 Callouts
...
footer: 范财胜（武汉理工大学） # 设置页脚区域的内容，如果设定页眉的内容，则为 header
---
```
